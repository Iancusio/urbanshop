...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20200519_urbanshop_45614bb4a6f5f5d67473_20200519174952_archive.zip';
	const ARCHIVE_SIZE		 = '35666227';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '45614bb-19174952';
    const SECONDARY_PACKAGE_HASH = '5b4c313-19174952';
	...
	public function run()
	{
		...
		self::log('==DUPLICATOR INSTALLER BOOTSTRAP v1.3.34==');
		self::log('----------------------------------------------------');
